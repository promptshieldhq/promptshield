...
Need a managed setup or help getting started? [Let's talk](mailto:contact@ajutamang.com).
...
<Cards>
  <Card title="Quickstart" href="/docs/quickstart" description="Proxy running in one terminal session" />
  <Card title="Secrets Detection" href="/docs/secrets" description="Block API keys, tokens, and credentials before the LLM sees them" />
  <Card title="Policy" href="/docs/policy" description="Block, mask, or allow per entity type" />
  <Card title="Providers" href="/docs/providers" description="Gemini, OpenAI, Anthropic, Ollama, any OpenAI-compatible endpoint" />
</Cards>
