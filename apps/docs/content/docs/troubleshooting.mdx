...
Check `PROMPTSHIELD_ENGINE_URL` is set in the gateway `.env`:
...
- Restart the gateway after changing the policy file
...
Open an issue at [github.com/promptshieldhq/promptshield-gateway](https://github.com/promptshieldhq/promptshield-gateway/issues).
